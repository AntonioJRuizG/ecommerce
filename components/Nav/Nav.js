...
export default function Nav({show}) {
	...
	return (
		<aside className={(show ? 'left-0' : '-left-full') + ' text-gray-700 p-4 flex flex-col gap-5 fixed w-full h-full bg-bggray md:static md:w-auto transition-all'}>
          ...
          Orders
				...
				<Link
					href={'/settings'}
					className={
						router.pathname === '/settings' ? activeLink : inactiveLink
					}
				>
					<svg
						xmlns='http://www.w3.org/2000/svg'
